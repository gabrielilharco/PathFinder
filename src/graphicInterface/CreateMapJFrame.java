...
public class CreateMapJFrame extends JFrame
{
	public CreateMapJFrame()
	{
		  ...
		  JButton bCreateMap = new JButton(new ImageIcon("res/from_file.png"));
		  ...
		  JButton bRunAlgorithm = new JButton(new ImageIcon("res/from_image.png"));
		  ...
		  JButton bRunStatistics = new JButton(new ImageIcon("res/draw_map.png"));
